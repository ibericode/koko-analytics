	...
	<div class="" style="max-width: 720px;">
		...
		<form method="POST" action="<?php echo add_query_arg(array( 'koko_analytics_action' => 'save_settings' )); ?>">
			...
			<div class="ka-margin-m">
				<label for="ka-exclude-user-roles"><?php esc_html_e('Exclude pageviews from these user roles', 'koko-analytics'); ?></label>
				<select id="ka-exclude-user-roles" multiple="" name="koko_analytics_settings[exclude_user_roles][]">
					<?php
			...
			<div class="ka-margin-m">
				<label><?php esc_html_e('Use cookie to determine unique visitors and pageviews?', 'koko-analytics'); ?></label>
				<label class="cb"><input type="radio" name="koko_analytics_settings[use_cookie]" value="1" <?php checked($settings['use_cookie'], 1); ?>><?php esc_html_e('Yes'); ?></label>
				<label class="cb"><input type="radio" name="koko_analytics_settings[use_cookie]" value="0" <?php checked($settings['use_cookie'], 0); ?>> <?php esc_html_e('No'); ?></label>
				<p class="description">
			...
			<div class="ka-margin-m">
				<label for="ka-default-date-period"><?php esc_html_e('Default date period', 'koko-analytics'); ?></label>
			...
			<div class="ka-margin-m">
				<label for="ka-prune-after-input"><?php esc_html_e('Automatically delete data older than how many months?', 'koko-analytics'); ?></label>
		...
		<div class="ka-margin-l">
			...
			<div class="ka-margin-m">
				...
				<p>
					<a href="<?php echo wp_nonce_url(add_query_arg(array( 'koko_analytics_action' => 'reset_statistics' ), 'koko_analytics_reset_statistics')); ?>" class="button button-primary"><?php esc_html_e('Reset Statistics', 'koko-analytics'); ?></a>
				</p>
			</div>
		</div>
	</div>
