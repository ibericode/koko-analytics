...
final class IndependentAnalyticsImporterTest extends TestCase
{
    ...
    {
        $db              = new IndependentAnalyticsImporterTestDb();
        $GLOBALS['wpdb'] = $db;
        $importer        = new Independent_Analytics_Importer();
...
class IndependentAnalyticsImporterTestDb extends \wpdb
{
    public $prefix = 'wp_';
    public $last_error = '';
    ...
    {
        if (str_contains($query, 'independent_analytics_resources')) {
            return [
                (object) [
                    'cached_url' => 'https://example.com/first/',
                    'post_id' => 5,
                    'visitors' => 3,
                    'pageviews' => 4,
                ],
                (object) [
                    'cached_url' => 'https://example.com/category/news/',
                    'post_id' => 0,
                    'visitors' => 2,
                    'pageviews' => 3,
                ],
        ...
        if (str_contains($query, 'independent_analytics_referrers')) {
            return [
                (object) [
