...
class Admin {
	...
	{
		$settings_link = '<a href="' . admin_url('index.php?page=koko-analytics#!/settings') . '">'. __('Settings') . '</a>';
	...
	public function add_plugin_meta_links($links, $file)
	{
		...
		$links[] = '<a href="https://www.kokoanalytics.com/#utm_source=wp-plugin&utm_medium=koko-analytics&utm_campaign=plugins-page">'. __('Visit plugin site') . '</a>';
		return $links;
	}
}
