...
<nav class="mb-3 list-inline text-end mt-0" style="margin-left: auto;">
    ...
    <ul class="list-inline m-0">
        <li class="list-inline-item m-0 ms-2"><a href="<?php echo esc_attr(home_url('?koko-analytics-dashboard')); ?>" <?php echo isset($_GET['koko-analytics-dashboard']) ? 'class="text-black" aria-current="page"' : ''; ?>><?php esc_html_e('Dashboard (full screen)', 'koko-analytics'); ?></a></li>
