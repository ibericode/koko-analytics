...
<div class="koko-analytics" style="background: inherit;">
    <div id="ka-dashboard-widget-realtime" class="mb-4">
        <h3 class="fs-6 mb-2 fw-bold"><?php esc_html_e('Realtime', 'koko-analytics'); ?></h3>
        <p class="m-0">
            ...
            <div class="ka-col">
                ...
                <ul class="list-unstyled m-0">
                    ...
                    <li>
                        ...
                        <span class="text-truncate"><a href="<?php echo esc_attr($post->path); ?>"><?php echo esc_html($post->path); ?></a></span>
                    </li>
                    <?php } ?>
                </ul>
            </div>
