 ...
 * All class names are prefixed with `ka-upsell-` to avoid clashing with wp-admin.
 */
...
.ka-upsell-logo{width:26px;height:26px;flex:none;display:block;border-radius:6px;object-fit:contain}
.ka-upsell-pro-badge{display:inline-flex;align-items:baseline;gap:6px;color:#6b7f83;font-size:11.5px;font-weight:700;letter-spacing:.13em;text-transform:uppercase}
.ka-upsell-pro-badge b{color:#069494;font-weight:700}
.ka-upsell-h{font-size:23px;line-height:1.22;font-weight:700;letter-spacing:-.01em;margin:14px 0 8px;color:#021630;text-wrap:balance}
.ka-upsell-h em{font-style:normal;color:inherit;text-decoration:none}
.ka-upsell-sub{font-size:14px;line-height:1.55;color:#48595f;max-width:60ch}
...
.ka-upsell-peek-h{display:flex;align-items:center;justify-content:space-between;font-size:11px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:#8598a0;margin-bottom:10px}
.ka-upsell-lock-tag{display:inline-flex;align-items:center;gap:5px;font-size:10.5px;font-weight:700;letter-spacing:.04em;color:#6a747e;background:#eef1f4;border:1px solid #dde3e9;padding:3px 8px;border-radius:20px;text-transform:none}
...
.ka-upsell-pnum{font-size:12.5px;font-weight:700;color:#6a747e;font-variant-numeric:tabular-nums;width:34px;text-align:right}
.ka-upsell-blurred{filter:blur(4px);opacity:.85;user-select:none;pointer-events:none}
.ka-upsell-cta{display:flex;flex-wrap:wrap;align-items:center;gap:18px;margin-top:20px}
...
.ka-upsell-reassure{display:flex;align-items:center;gap:7px;font-size:12px;color:#6a7d90;margin-top:14px}
...
<div class="ka-upsell-brandrow"><img class="ka-upsell-logo" src="<?php echo esc_url(plugins_url('/assets/img/icon.svg', KOKO_ANALYTICS_PLUGIN_FILE)); ?>" alt="Koko Analytics" width="26" height="26"><span class="ka-upsell-pro-badge">Koko Analytics <b>Pro</b></span></div>
<div class="ka-upsell-h">You're seeing half the story. <em>Unlock the other half.</em></div>
...
<div class="ka-upsell-reassure"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#5a8a5a" stroke-width="2"><path d="M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6z"></path><path d="M9 12l2 2 4-4"></path></svg>Still 100% cookieless. Still no third-party services. Your data stays on your server.</div>
<div class="ka-upsell-cta">
<a class="ka-upsell-btn" href="<?php echo esc_url($koko_pro_price_url); ?>" target="_blank">Upgrade to Pro<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.4"><path d="M5 12h13M13 6l6 6-6 6"></path></svg></a>
<a class="ka-upsell-link" href="<?php echo esc_url($koko_pro_more_url); ?>" target="_blank">View Pro features</a>
</div>
</div>
<div class="ka-upsell-peek">
<div class="ka-upsell-peek-h"><span>Top countries</span><span class="ka-upsell-lock-tag"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#8a949e" stroke-width="2.5"><rect x="5" y="11" width="14" height="9" rx="1.5"></rect><path d="M8 11V8a4 4 0 018 0v3"></path></svg>Pro</span></div>
