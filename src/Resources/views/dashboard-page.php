        ...
        <div class="d-flex gap-3 mb-3">
            <div class="position-relative">
                ...
                <div id="ka-datepicker-dropdown" class="rounded bg-white shadow" style="display: none; position: absolute; width:360px; z-index: 9992;">
                    <?php $show_date_navigation = KokoAnalytics\Dashboard::shows_pagination_links(); ?>
                    <div class="mb-3 bg-dark text-white p-3 rounded-top fw-bold d-flex <?= $show_date_navigation ? 'justify-content-between' : 'justify-content-center'; ?>">
                        <?php if ($show_date_navigation) { ?>
                            <?php
