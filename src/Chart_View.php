    ...
    public function __construct(array $data, \DateTimeInterface $dateStart, \DateTimeInterface $dateEnd, int $height = 280, bool $showGroupOptions = true, string $group = 'day')
    {
        ...
        <div class="ka-chart">
            ...
            <div class="text-end text-muted mb-2">
                ...
                <?php if ($daysDiff > 31) {
                    ?><a class="text-muted" rel="nofollow" href="<?= esc_attr(add_query_arg(['group' => 'month'])); ?>"><?php esc_html_e('months', 'koko-analytics'); ?></a><?php
                } ?>
                <?php if ($daysDiff > 365) {
                    ?><a class="text-muted" rel="nofollow" href="<?= esc_attr(add_query_arg(['group' => 'year'])); ?>"><?php esc_html_e('years', 'koko-analytics'); ?></a><?php
                } ?>
            </div>
